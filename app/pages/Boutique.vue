...
const addToCart = (product: Product) => {
  ...
  try {
    ...
    if (err.message.startsWith("Stock insuffisant")) {
      warning(
        "Stock insuffisant",
        `La quantité demandée pour "${product.name}" dépasse le stock disponible. `,
      );
      return;
    }
...
<template>
  <div class="bg-dark">
    ...
    <!-- Hero Section -->
    <section
      class="bg-linear-to-b from-dark to-[#1a2332] container mx-auto px-4 py-8 mb-4"
    >
      <div class="mx-auto max-w-7xl text-center">
        ...
        <p class="text-light-blue/70 text-lg md:text-xl max-w-2xl mx-auto">
          Découvrez notre sélection de produits, adhésions et tickets pour nos
          événements
        </p>
      </div>
    </section>
    ...
    <section class="container mx-auto px-4 mb-8">
      <div class="mx-auto max-w-7xl">
        <div class="flex items-center gap-2 mb-6">
          ...
          <span class="text-light-blue font-semibold"
    ...
    <section class="container mx-auto px-4 pb-16">
      <div class="mx-auto max-w-7xl">
        ...
        >
          ...
          >
            ...
            <div class="relative h-48 bg-blue/30 overflow-hidden">
              ...
              <div
                v-else
                class="h-full w-full flex items-center justify-center bg-linear-to-br from-blue/40 to-light-blue/20"
              >
                <component
                  :is="getCategoryIcon(product.category)"
                  class="h-20 w-20 text-light-blue/30"
                />
              </div>

              <!-- Category Badge -->
              <div
                class="absolute top-3 right-3 px-3 py-1 rounded-full bg-blue/80 backdrop-blur-sm border border-light-blue/30"
              >
            ...
            <div class="p-6">
              <h3
                class="text-xl font-bold text-white mb-2 group-hover:text-light-blue transition-colors"
              >
                {{ product.name }}
              </h3>
              ...
              <p
                ...
                class="text-light-blue/60 text-sm mb-4 line-clamp-2"
              >
                {{ product.description }}
              </p>
              ...
              <div class="flex items-center justify-between gap-2 mt-4">
                ...
                <!-- Quantity Selector -->
                <div
                  class="flex items-center gap-2 bg-blue/20 rounded-lg border border-light-blue/30 p-1"
                >
                  <button
                  ...
                  <span
                    class="w-8 text-center text-sm font-medium text-light-blue"
                  >
                ...
                <UButton
                  ...
                  :class="[
                    ...
                    product.stock <= 0
                      ...
                      : 'bg-linear-to-r from-light-blue to-cyan-500 text-[#2c3e50] hover:from-cyan-300 hover:to-light-blue hover:shadow-lg hover:shadow-light-blue/30',
                  ]"
        ...
        <div v-else class="text-center py-16">
          ...
          <h3 class="text-2xl font-bold text-light-blue mb-2">
          ...
          <UButton
            class="bg-linear-to-r from-light-blue to-cyan-500 px-6 py-3 font-semibold text-[#2c3e50] hover:from-cyan-300 hover:to-light-blue"
