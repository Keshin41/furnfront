...
<template>
  <div class="w-full p-4 md:p-6">
    <div
      class="mb-4 rounded-3xl border border-brand-light-blue/60 bg-linear-to-r from-brand-white via-brand-white to-brand-light-blue/20 p-5 shadow-sm md:p-6"
    >
    ...
    <div
      class="rounded-2xl border border-brand-light-blue/60 bg-brand-white p-2 shadow-xs md:p-3"
    >
      <UTable
        :columns="columns"
        :data="data ?? []"
