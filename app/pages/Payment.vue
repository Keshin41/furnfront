...
onMounted(async () => {
  ...
  try {
    ...
    error(
      "Erreur",
      err.message || "Impossible de charger le formulaire de paiement",
    );
  }
});
    ...
    if (paymentIntent?.status === "succeeded") {
      ...
      try {
        ...
        if (response.ok && data.success) {
          ...
          orderNumber.value =
            data.order_number || orderId.value?.toString() || "";
          ...
          throw new Error(
            data.error || "Erreur lors de la confirmation du paiement",
          );
        }
      } catch (fetchError: any) {
        console.error("Fetch error:", fetchError);
        throw new Error(
          fetchError.message || "Erreur de communication avec le serveur",
        );
      }
    }
  } catch (err: any) {
    ...
    <div class="min-h-screen bg-dark py-12 px-4 sm:px-6 lg:px-8">
      <div class="max-w-5xl mx-auto">
        ...
        <div class="text-center mb-12">
          <h1 class="text-4xl font-bold text-light-blue mb-2">
            Paiement sécurisé
          </h1>
          <p class="text-light-blue/70">
        ...
        <div
          v-if="isLoading"
          class="bg-blue/20 rounded-lg shadow-md p-12 text-center"
        >
        ...
        <div
          v-else-if="hasError"
          class="bg-red-500/10 border-2 border-red-500/40 rounded-lg p-8 text-center"
        >
          ...
          <UButton
            class="bg-blue text-black hover:bg-blue/80"
            @click="router.visit('/boutique/panier')"
          >
            Retour au panier
          </UButton>
        </div>
        ...
        <!-- Paiement complété -->
        <div
          v-else-if="paymentCompleted"
          class="bg-green-500/10 border-2 border-green-500/40 rounded-lg p-8 text-center"
        >
          ...
          <p class="text-light-blue/50 text-xs mt-4">
            Redirection vers votre facture...
          </p>
        </div>
        ...
        <div v-else class="grid lg:grid-cols-2 gap-12">
          ...
          <div class="flex flex-col justify-center">
            ...
            <div class="perspective h-80 mb-8">
              ...
              >
                ...
                >
                  <!-- Effets de fond -->
                  <div
                    class="absolute top-0 right-0 w-40 h-40 bg-white/10 rounded-full -mr-20 -mt-20 blur-3xl"
                  />
                  <div
                    class="absolute bottom-0 left-0 w-32 h-32 bg-white/5 rounded-full -ml-16 -mb-16 blur-2xl"
                  />
                  ...
                  <div class="relative h-full flex flex-col justify-between">
                    ...
                    <div class="flex justify-between items-start">
                      <div
                        class="w-12 h-10 bg-linear-to-br from-yellow-300 to-yellow-600 rounded-lg shadow-lg"
                      />
                    ...
                    <div class="space-y-4">
                      ...
                      <div class="grid grid-cols-2 gap-8">
                        <div>
                          <p class="text-xs opacity-75 uppercase tracking-wide">
                            Titulaire
                          </p>
                ...
                <div
                  class="absolute w-full h-full bg-linear-to-br from-blue via-cyan-500 to-light-blue rounded-2xl shadow-2xl p-8 text-white flex flex-col justify-center"
                  :style="{
                    backfaceVisibility: 'hidden',
                    transform: 'rotateY(180deg)',
                  }"
                >
                  <div class="bg-black/30 h-14 w-full mb-6" />
                  <div class="flex justify-end pr-4">
                    <div
                      class="bg-white/20 h-10 w-16 rounded flex items-center justify-center"
                    >
            ...
            <div class="bg-blue/10 border border-light-blue/20 rounded-xl p-4">
              <div class="flex items-center gap-3">
                <Lock class="w-5 h-5 text-blue shrink-0" />
                <div class="text-sm">
                  <p class="font-semibold text-light-blue">
                    Paiement 100% sécurisé
                  </p>
                  <p class="text-xs text-light-blue/70">
                    Vos données sont cryptées par Stripe
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="flex flex-col justify-center">
            <div
              class="bg-blue/20 border border-light-blue/30 rounded-2xl shadow-2xl p-8"
            >
              <h2 class="text-2xl font-bold text-light-blue mb-8">
              ...
              <form class="space-y-6" @submit.prevent="handleSubmit">
                ...
                <div>
                  <label
                    class="block text-sm font-semibold text-light-blue mb-3"
                ...
                <div>
                  <label
                    class="text-sm font-semibold text-light-blue mb-3 flex items-center gap-2"
                  >
                  ...
                  <div
                    ...
                    class="bg-dark/50 px-4 py-4 border border-light-blue/30 rounded-xl focus-within:ring-2 focus-within:ring-blue focus-within:border-transparent transition-all"
                  />
                </div>
                ...
                <!-- Résumé montant -->
                <div
                  class="bg-linear-to-r from-blue/10 to-cyan-500/10 border border-light-blue/20 rounded-xl p-6"
                >
                  ...
                  <p class="text-xs text-light-blue/60">
                    TTC - Paiement unique
                  </p>
                </div>
                ...
                <p class="text-center text-light-blue/50 text-xs">
                  ...
                  <a
                    href="#"
                    class="text-blue hover:text-cyan-500 font-semibold"
              ...
              <!-- Mode test info -->
              <div
                class="mt-8 bg-yellow/10 border border-yellow/40 rounded-xl p-4"
              >
                <div class="flex items-start gap-3">
                  <AlertCircle class="w-5 h-5 text-yellow shrink-0 mt-0.5" />
                  <div class="text-sm">
                    <p class="font-semibold mb-2 text-yellow">
                      Mode test Stripe
                    </p>
                    <p class="text-xs text-light-blue/70 mb-3">
                      Testez avec ces données :
                    </p>
                    <div class="space-y-1 text-xs text-light-blue/70 font-mono">
                      <p>
                        ✓ Carte valide:
                        <span class="text-green-400">4242 4242 4242 4242</span>
                      </p>
                      <p>
                        ✗ Paiement échoué:
                        <span class="text-red-400">4000 0000 0000 0002</span>
                      </p>
