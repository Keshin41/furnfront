...
<template>
  ...
  <section class="relative h-screen w-full overflow-hidden">
    ...
    <!-- Contenu -->
    <div
      class="mt-32 relative z-10 flex h-full flex-col items-center px-4 text-white"
    >
      <!-- Titre principal -->
      ...
      <p class="mb-12 text-center text-lg md:text-xl lg:text-2xl">
        {{
          nextFurMeet
            ? "Prochaine Fur'Meet le " + nextFurMeet.date
            : "Prochaine fur'Meet à venir bientôt"
        }}
      </p>
      ...
      <div class="mb-16 flex flex-col gap-4 sm:flex-row">
        <UButton
          ...
          target="_blank"
          size="lg"
          class="bg-transparent border-2 border-light-blue hover:bg-light-blue/20 text-white px-6 py-6 text-xl font-semibold [&_svg]:size-7!"
        >
        ...
        <UButton
          ...
          href="/boutique"
          size="lg"
          class="bg-transparent border-2 border-yellow text-white hover:bg-yellow/20 px-8 py-6 text-lg font-semibold"
        >
          BOUTIQUE
        </UButton>
      </div>
      ...
      <!-- Scroll indicator -->
      <button class="animate-bounce cursor-pointer" @click="scrollToContent">
      ...
      <div class="right-4 mt-25 text-xl text-light-blue opacity-70">
        La vidéo est de
        <a
          href="https://www.youtube.com/@Alriou"
          class="underline hover:opacity-100 text-blue"
          >@ARIOIJ</a
        >
      </div>
    </div>
    ...
    <div class="container mx-auto px-4">
      ...
      <div class="mb-12 text-center">
        ...
        <p class="mx-auto max-w-2xl text-lg text-muted-foreground">
          Si vous avez un furbar et que vous voulez un {ville}.furbar.fr, vous
          pouvez DM
          <a
            href="https://t.me/pandarch"
            target="_blank"
      ...
      <div
        v-else
        class="rounded-lg border-2 border-dashed border-muted p-12 text-center"
      >
  ...
  <section class="relative bg-dark py-20">
    <div class="container mx-auto px-4">
      <div class="mx-auto max-w-6xl">
        <h2
          class="mb-4 text-center text-4xl font-bold text-light-blue md:text-5xl"
        >
          Fur N'Tours, en chiffre
        </h2>
        <p class="mb-16 text-center text-lg text-gray-400">
        ...
        <div class="grid gap-8 md:grid-cols-3">
          <!-- Stat 1: Membres -->
          <div
            class="group relative overflow-hidden rounded-lg shadow-xl shadow-blue/20 bg-[#ffffff0d] hover:-translate-y-0.5 hover:shadow-yellow/20 transition-all duration-300"
          >
            <!-- Barre cyan en haut -->
            <div class="h-1 w-full bg-light-blue" />

            <div class="p-8 text-center">
              <p
                class="mb-2 text-sm font-semibold uppercase tracking-wider text-light-blue"
              >
                Membres
              </p>
  ...
  <section class="relative bg-dark py-20">
    <div class="container mx-auto px-4">
      <div class="mx-auto max-w-6xl">
        <h2
          class="mb-16 text-center text-4xl font-bold text-light-blue md:text-5xl"
        >
          Nous Contacter
        </h2>
        ...
        <div class="grid gap-8 md:grid-cols-2">
          ...
          <div class="space-y-6">
            <!-- Email -->
            <div
              class="group relative overflow-hidden rounded-lg border border-light-blue/30 bg-blue/20 p-6 transition-all duration-300 hover:border-light-blue/50 hover:shadow-lg hover:shadow-light-blue/20"
            >
              <div class="flex items-center gap-4">
                <div class="rounded-full bg-light-blue/10 p-3">
                  <svg
                    class="h-6 w-6 text-light-blue"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <div>
                  <a
                    href="mailto:contact@furntours.fr"
                    class="text-lg text-light-blue hover:text-cyan-300"
                  >
  ...
  <!-- Section Staff -->
  <section class="relative bg-linear-to-br from-[#2c3e50] to-[#34495e] py-10">
    <div class="container mx-auto px-4">
      <div class="mx-auto max-w-6xl">
        <h2
          class="mb-8 text-center text-4xl font-bold text-cyan-400 md:text-5xl"
        >
          Le staff
        </h2>
        ...
        <div class="flex flex-wrap justify-center gap-8 md:gap-12">
          ...
          >
            ...
            <div class="mb-3 flex justify-center">
              <div
                class="relative h-32 w-32 overflow-hidden rounded-full border-4 border-cyan-400/30 transition-all duration-300 group-hover:border-cyan-400/50"
              >
                <img
                  v-if="member.photo"
                ...
                <div
                  v-else
                  class="h-full w-full bg-linear-to-br from-[#2c3e50] to-[#34495e] flex items-center justify-center text-4xl text-cyan-400 font-bold"
                >
            ...
            <!-- Réseaux sociaux -->
            <div
              v-if="member.social_links && member.social_links.length > 0"
