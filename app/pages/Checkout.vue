...
import { AlertCircle, ArrowLeft, Lock, Truck } from "lucide-vue-next";
  ...
  try {
    ...
    router.post("/boutique/checkout", orderData, {
      onError: (pageProps: any) => {
        loading.value = false;
        const errorMsg =
          pageProps?.error || "Impossible de traiter la commande";
    ...
    <div class="min-h-screen bg-dark py-12 px-4 sm:px-6 lg:px-8">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-8">
          ...
          <h1 class="text-3xl font-bold text-light-blue">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-blue/20 rounded-lg shadow-md p-8">
              ...
              <div class="mb-8">
                ...
                <div class="grid grid-cols-2 gap-4">
                  <div>
                    <label
                      class="block text-sm font-medium text-light-blue mb-1"
                    >
                      Prénom
                    </label>
                    <input
              ...
              <div class="mb-8 pb-8 border-b">
                <h2
                  class="text-xl font-semibold text-blue mb-4 flex items-center gap-2"
                >
                  <Truck class="w-5 h-5" />
                  Adresse de livraison
                </h2>
              ...
              <div class="mb-8">
                ...
                <div class="space-y-3">
                  <label
                    class="flex items-center p-4 border border-light-blue/20 rounded-lg cursor-pointer"
                    :class="
                      formData.paymentMethod === 'stripe'
                        ? 'border-blue-500 bg-blue text-gray-500'
                        : 'hover:bg-blue/20'
                    "
                  >
                    <input
              ...
              <!-- Conditions -->
              <div
                class="bg-yellow/10 border-2 border-yellow/40 rounded-lg p-4 flex items-start gap-3 shadow-lg shadow-yellow/5"
              >
                <AlertCircle class="w-5 h-5 text-yellow flex-shrink-0 mt-0.5" />
                <div class="text-sm">
                  <p class="font-semibold mb-1 text-yellow">
                    Avant de finaliser
                  </p>
                  <p class="text-xs text-light-blue/90">
                    En cliquant sur "Finaliser la commande", vous acceptez nos
          ...
          <div class="lg:col-span-1">
            <div class="bg-blue/20 rounded-lg shadow-md p-6 sticky top-30">
              <h2 class="text-lg font-semibold text-blue mb-4">
                Résumé de commande
              </h2>
              ...
              <div v-if="cartItems.length === 0" class="text-center py-8">
                ...
                <Link
                  ...
                  class="text-blue hover:text-blue text-sm mt-2 block"
                >
                  Retour au panier
                </Link>
              </div>
              ...
              <div v-else>
                <div class="space-y-3 mb-6">
                  ...
                  >
                    <div class="">
                      ...
                      <p class="text-xs text-light-blue ml-0.5">
                ...
                <div class="border-t pt-4">
                  ...
                  <div class="border-t mt-4 pt-4">
                    <div class="flex justify-between">
                      <span class="text-lg font-semibold text-light-blue"
                        >Total</span
                      >
                ...
                <Link
                  href="/boutique/panier"
                  class="block text-center text-light-blue hover:text-blue text-sm mt-3"
                >
                  Modifier le panier
                </Link>
              </div>
