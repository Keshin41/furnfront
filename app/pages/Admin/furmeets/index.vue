    ...
    <section class="container mx-auto px-4">
      <div class="mx-auto max-w-7xl">
        ...
        <div
          ...
          class="overflow-hidden rounded-lg border border-light-blue/30 bg-blue/20"
        >
          <table class="w-full">
            <thead class="bg-[#2c3e50]">
              <tr>
                <th
                  class="px-6 py-4 text-left text-sm font-semibold text-light-blue"
                >
                  ID
                </th>
                <th
                ...
                <td class="px-6 py-4">
                  <div>
                    ...
                    <p class="text-sm text-gray-400 line-clamp-1">
                      {{
                        getTextFromHtml(furMeet.description).substring(0, 100)
                      }}...
                    </p>
                  </div>
                </td>
