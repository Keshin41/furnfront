            ...
            <div class="mx-auto max-w-md">
                <div class="rounded-lg border border-white/15 bg-[#1f2a3b] p-8 shadow-2xl shadow-black/30">
                    ...
                    <Form class="flex flex-col gap-6" @submit.prevent="submit">
                        <div class="grid gap-6">
                            <div class="grid gap-2">
                                ...
                                <Input id="email" name="email" type="email" v-model="form.email" required autofocus
                                    autocomplete="email" placeholder="admin@furntours.com"
                        ...
                        <Button type="submit"
                            class="mt-2 w-full bg-gradient-to-r from-cyan-300 to-light-blue text-[#0f172a] hover:from-cyan-200 hover:to-cyan-300"
