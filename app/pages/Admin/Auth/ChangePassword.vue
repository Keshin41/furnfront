      ...
      <div class="container mx-auto px-4">
        <div class="mx-auto max-w-xl rounded-lg border border-light-blue/30 bg-dark/60 p-6">
          ...
          <form @submit.prevent="submit" class="space-y-4">
            <div>
              <label for="current_password" class="mb-2 block text-sm font-medium text-gray-200">Mot de passe
                actuel</label>
              ...
              <div v-if="form.errors.current_password" class="mt-1 text-sm text-red-400">{{ form.errors.current_password
              }}</div>
            </div>
            ...
            <div>
              <label for="password_confirmation" class="mb-2 block text-sm font-medium text-gray-200">Confirmer le mot
                de passe</label>
            ...
            <div class="pt-2 flex gap-3">
              ...
              <Button type="button" variant="outline" class="border-gray-600 text-gray-200 hover:bg-gray-700"
                @click="logout">
                Se déconnecter
              </Button>
            </div>
