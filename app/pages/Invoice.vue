...
<template>
  <div class="min-h-screen bg-dark py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
      ...
      <!-- Success Message -->
      <div
        class="mt-8 bg-green-500/10 border border-green-500/30 rounded-lg p-6 mb-6"
      >
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-light-blue/70 text-sm">
              Votre commande a été traitée avec succès. Vous pouvez télécharger
              votre facture ou continuer vos achats.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-blue/20 rounded-lg border border-light-blue/30 p-8">
        <!-- Invoice Header -->
        <div
          class="flex justify-between items-start mb-8 pb-8 border-b border-light-blue/30"
        >
          <div>
          ...
          <div class="text-right">
            <p class="text-light-blue font-semibold">
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-8">
          <div>
            <p class="text-light-blue/70 text-sm mb-3 uppercase font-semibold">
              Facturé à
            </p>
          ...
          <div>
            ...
            <div class="text-light-blue text-sm space-y-2">
              ...
              <p>
                ...
                <span
                  class="inline-block px-3 py-1 rounded text-xs font-medium bg-green-500/20 text-green-400 border border-green-500/30"
                  >{{ order.status }}</span
                >
              </p>
            </div>
          ...
          <div class="overflow-x-auto">
            <table class="w-full">
              <thead class="border-b border-light-blue/30">
                <tr>
                  <th class="text-left py-3 px-4 text-light-blue font-semibold">
                    Description
                  </th>
                  <th
                    class="text-right py-3 px-4 text-light-blue font-semibold"
                  >
                    Quantité
                  </th>
                  <th
              ...
              <tbody>
                <tr
                  ...
                  :key="item.id"
                  class="border-b border-light-blue/20 hover:bg-blue/30"
                >
                  <td class="py-3 px-4 text-light-blue">{{ item.name }}</td>
                  <td class="text-right py-3 px-4 text-light-blue">
                    {{ item.quantity }}
                  </td>
                  <td class="text-right py-3 px-4 text-light-blue">
        ...
        <div class="flex justify-end mb-8">
          <div class="w-64">
            <div
              class="flex justify-between py-3 border-t-2 border-light-blue/30 text-light-blue"
            >
              <span class="font-semibold">Total TTC :</span>
              <span class="text-2xl font-bold text-blue"
        ...
        <!-- Footer -->
        <div
          class="text-center text-light-blue/60 text-xs pt-8 border-t border-light-blue/30"
        >
          <p>
            Merci pour votre achat ! Cette facture est valable dans nos
            registres.
          </p>
