    ...
    <section class="container mx-auto px-4 py-12">
      <div class="mx-auto max-w-4xl">
        <div class="flex items-center gap-4 mb-8">
          ...
          <h1
            class="font-bold text-light-blue text-4xl flex items-center gap-3"
          >
        ...
        <div
          ...
          class="text-center py-16 rounded-lg border border-light-blue/30 bg-blue/20"
        >
          <Package class="h-20 w-20 mx-auto mb-6 text-light-blue/30" />
          <h2 class="text-2xl font-bold text-light-blue mb-2">
        ...
        <div v-else class="space-y-6">
          ...
          <div class="space-y-4">
            ...
            >
              <div class="flex gap-6">
                <!-- Image -->
                <div
                  class="h-24 w-24 shrink-0 rounded overflow-hidden bg-blue/30"
                >
                  <img
                    v-if="item.image"
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex items-start justify-between mb-2">
                    <div>
                      ...
                      <p class="text-sm text-light-blue/60 mt-1">
                  ...
                  <div class="flex items-center justify-between mt-4">
                    ...
                    <div class="flex items-center gap-3">
                      ...
                      <div
                        class="flex items-center gap-2 bg-blue/30 rounded border border-light-blue/30"
                      >
                        <button
                        ...
                        <span
                          class="w-12 text-center font-semibold text-white"
                          >{{ item.quantity }}</span
                        >
                        <button
                    ...
                    <div class="text-right">
                      <div class="text-sm text-light-blue/60">
          ...
          <div class="rounded-lg border border-light-blue/30 bg-blue/20 p-6">
            <div class="space-y-3">
              ...
              <div
                class="border-t border-light-blue/30 pt-3 flex items-center justify-between"
              >
                <span class="text-xl font-semibold text-light-blue">Total</span>
                <span class="text-3xl font-bold text-light-blue"
            ...
            <div class="flex gap-3 mt-6">
              ...
              <Link href="/boutique/checkout" as="button" class="flex-1">
                <Button
                  class="w-full bg-linear-to-r from-light-blue to-cyan-500 text-[#2c3e50] hover:from-cyan-300 hover:to-light-blue font-semibold shadow-lg hover:shadow-xl transition-all"
                >
                  Passer la commande
                </Button>
              </Link>
