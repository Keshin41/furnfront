  ...
  <Popover>
    ...
    <PopoverContent class="w-80 p-0" align="end">
      ...
      >
        ...
        <span class="text-sm text-light-blue/60"
          >{{ itemCount }} article(s)</span
        >
      </div>
      ...
      >
        ...
        <p class="text-sm text-light-blue/60 text-center">
        ...
        >
          ...
          <div class="flex-1 min-w-0">
            ...
            <div class="flex items-center gap-1 mt-2">
              ...
              <span
                class="w-6 text-center text-xs font-medium text-light-blue"
                >{{ item.quantity }}</span
              >
              <button
                @click="
      ...
      <div
        v-if="cartItems.length > 0"
        class="border-t border-light-blue/30 bg-blue/20 p-4 space-y-3"
      >
        <div class="flex items-center justify-between">
          <span class="font-semibold text-light-blue">Total</span>
          <span class="text-xl font-bold text-light-blue"
