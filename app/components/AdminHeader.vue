...
import { ClipboardList, FileText, List, LogOut, Settings, ShoppingBag, User, Users } from 'lucide-vue-next';
        ...
        <div class="container mx-auto px-4">
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="flex items-center gap-8">
                    ...
                    <nav class="hidden md:flex items-center gap-4">
                        <Button as="a" href="/admin/furmeets" variant="ghost" size="sm" :class="[
                        ...
                        <Button v-if="canManageUsers" as="a" href="/admin/staff" variant="ghost" size="sm" :class="[
                            'hover:text-light-blue hover:bg-light-blue/10',
                        ...
                        <Button v-if="canManageSettings" as="a" href="/admin/settings" variant="ghost" size="sm" :class="[
                            'hover:text-light-blue hover:bg-light-blue/10',
                        ...
                        <Button v-if="canManageOrders" as="a" href="/admin/orders" variant="ghost" size="sm" :class="[
                            'hover:text-light-blue hover:bg-light-blue/10',
                        ...
                        <Button v-if="canManageInvoices" as="a" href="/admin/invoices" variant="ghost" size="sm" :class="[
                            'hover:text-light-blue hover:bg-light-blue/10',
                        ...
                        <Button as="a" href="/admin/products" variant="ghost" size="sm" :class="[
                            'hover:text-light-blue hover:bg-light-blue/10',
                ...
                <div class="flex items-center gap-4">
                    ...
                    <button
                        ...
                        @click="toggleMobile" aria-label="Ouvrir le menu">
                        <List class="h-5 w-5" />
                    </button>

                    <a href="/" class="text-sm text-gray-400 hover:text-light-blue transition-colors">
                        Retour au site
                    </a>
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger as-child>
                            <button
                                class="flex items-center gap-2 rounded-full hover:ring-2 hover:ring-light-blue/50 transition-all">
                                <Avatar class="h-9 w-9 border-2 border-light-blue/40">
                                    <AvatarImage v-if="user?.photo" :src="`/storage/${user.photo}`" :alt="user?.name" />
                                    <AvatarFallback
                                        class="bg-gradient-to-br from-light-blue to-cyan-500 text-[#0f172a] font-semibold">
                                        {{ userInitials }}
                                    </AvatarFallback>
                                </Avatar>
            ...
            <div v-if="mobileOpen" class="md:hidden pb-4">
                <div class="mt-2 space-y-2 rounded-lg border border-light-blue/30 bg-blue/20 p-3">
                    ...
                    <a v-if="canManageSettings" href="/admin/settings" :class="[
                        'flex items-center gap-2 rounded px-3 py-2 text-sm font-medium',
                    ...
                    <a v-if="canManageUsers" href="/admin/staff" :class="[
                        'flex items-center gap-2 rounded px-3 py-2 text-sm font-medium',
                    ...
                    <a v-if="canManageOrders" href="/admin/orders" :class="[
                        'flex items-center gap-2 rounded px-3 py-2 text-sm font-medium',
                    ...
                    <a v-if="canManageInvoices" href="/admin/invoices" :class="[
                        'flex items-center gap-2 rounded px-3 py-2 text-sm font-medium',
